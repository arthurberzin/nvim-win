...
require('bufferline').setup {
  options = {
      ...
      close_command = function(id) pcall(closeBuffArg,id) end,          -- can be a string | function, see "Mouse actions"
      right_mouse_command = function(id) pcall(closeBuff,id) end,     -- can be a string | function, see "Mouse actions"
      left_mouse_command = function(id) pcall(buffSelect,id) end,       -- can be a string | function, see "Mouse actions"
      middle_mouse_command = function(id) pcall(closeBuff,id) end,   -- can be a string | function, see "Mouse actions"
      indicator = {
